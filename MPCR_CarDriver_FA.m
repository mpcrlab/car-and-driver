...
for loop=1:100
    ...
    b=0.1; %Comment this line and uncomment the next
    %b=1; 
...
%     
%     subplot(142)
%     imagesc(HahnWTA(act2))
%     
%     subplot(143)
%     imagesc(abs(category-HahnWTA(act2)))
%     
%     subplot(144)
%     plot(sseplot)
